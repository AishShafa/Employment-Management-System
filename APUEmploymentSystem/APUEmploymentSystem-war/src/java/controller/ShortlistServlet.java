 ...
 * @author aisha
 */
@WebServlet(name = "ShortlistServlet", urlPatterns = {"/ShortlistServlet"})
public class ShortlistServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Create a notification for the shortlisted applicant
        ...
        try {
            ...
            request.setAttribute("successMessage", "Shortlist notification sent to " + email);
        } catch (Exception e) {
            e.printStackTrace(); // Log any exception
            request.setAttribute("errorMessage", "Failed to send shortlist notification to " + email);
        }
